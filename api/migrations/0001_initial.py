# Generated by Django 5.1.4 on 2026-02-02 12:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_id', models.CharField(blank=True, editable=False, max_length=25, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('CASH', 'Cash'), ('CARD', 'Credit/Debit Card'), ('MOBILE_MONEY', 'Mobile Money'), ('CHECK', 'Check')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimate_time', models.IntegerField(default=24, help_text='Duration in Hours')),
                ('actif', models.BooleanField(null=True)),
